...
public class lab8 {
	...
	public static void main(String[] args)
	{
		 ...
		 * When I search for 7 within myArray = found --> boolean = true;
		...
		System.out.println("\n======ADDING ANOTHER NUMBER TO THE ARRAY======"); 
		System.out.print("What number would you like to add: ");
		double extraNum = input.nextDouble();
		myArray = addAnotherNumber(reverseArray(myArray), extraNum); //Have to reverse back to normal from here
