...
public class Lab11Exercise1 {
	...
	public static void main(String[] args)
	{
		...
		while (month < 1 || month > 12) //if the month isn't between 1 and 12
		{
			monthAsString = JOptionPane.showInputDialog("Invalid! Please enter a month number (1-12) ");
			month = Integer.parseInt(monthAsString);
		...
		winterRainfall = rainfall[0] + rainfall[1] + rainfall[11];
		JOptionPane.showMessageDialog(null, "Total rainfall for the Winter month is: " + winterRainfall + "mm"
				, "Rainfall Stats", JOptionPane.PLAIN_MESSAGE);
		
		//Calculating the total rainfall for Spring
				springRainfall = rainfall[2] + rainfall[3] + rainfall[4];
				JOptionPane.showMessageDialog(null, "Total rainfall for the Spring month is: " + springRainfall + "mm"
						, "Rainfall Stats", JOptionPane.PLAIN_MESSAGE);
