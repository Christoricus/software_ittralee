 ...
 *stats based on the values entered. This program validates the tnumber value entered and the gender value also*/
		 	...
		 	for (int i = 1; i <= 3; i++)
		 	  { 	  
			    ...
			    while(!gender.equals("male") && !gender.equals("female"))
				    {
				    	gender = JOptionPane.showInputDialog("Invalid!Please re-enter the "
			 			  			      + "gender of student "  + i);
				    }
