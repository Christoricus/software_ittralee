...
public class WeightTest {
	public static void main(String args[]) {
		System.out
				.println("Start off by creating a Weight object using the no-arg constructor");
		Weight w1 = new Weight();
		System.out
				.println("First weight, created via no-arg copy constructor is "
						+ w1);
		System.out
				.println("Now create a second Weight object using the 2-arg copy constructor, making it 12st and 6lbs");
		...
		System.out
				.println("Note that the internal setPounds() method in Weight didn't allow a value of 17");
		System.out.println("\nFinally, create a third weight, this time 65 kg");
		Weight w3 = new Weight(65.5);
		System.out
				.println("Weight 3 in kg is (note the effects of lack of precision): "
						+ w3.getKilos());
