...
public class TraineeTest {
	public static void main(String args[]) {
		...
		System.out
				.println("Values of the Trainee object p1:\n" + p1.toString());
		...
		System.out
				.println("The address of the Trainee object p1 ( obtained using getAddress() ) is now "
						+ p1.getAddress());
		System.out
				.println("\n\nCheck the functionality of the getStartWeight() method separately on p2");
		System.out.println("Starting weight of the Trainee p2 is "
				+ p2.getStartWeight().toString());
		System.out
				.println("\n\nCan also set the starting weight of p2 to 14 st 6 oz using setStartWeight()");
		p2.setStartWeight(14, 6);

		System.out.println("New starting weight of the Trainee p2 is "
				+ p2.getStartWeight().toString());
	}
}