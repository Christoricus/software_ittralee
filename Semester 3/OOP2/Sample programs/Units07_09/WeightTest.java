...
public class WeightTest{
   public static void main(String args[]) {
      ...
      System.out.println("First weight, created via no-arg copy constructor is " + w1);         
      System.out.println("Now create a second Weight object using the 2-arg copy constructor, making it 12st and 6lbs");
